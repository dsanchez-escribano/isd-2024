...
public class RestEntradaDto {
    ...
    public RestEntradaDto(Long entradaID, String email, String ultimosDigitosTarjeta, int numeroEntradas, String fechaCompra, boolean estado, Long partidoID) {
