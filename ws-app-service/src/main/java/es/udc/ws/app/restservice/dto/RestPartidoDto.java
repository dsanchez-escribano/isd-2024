...
public class RestPartidoDto {
    ...
    public RestPartidoDto(Long partidoID, String nombreVisitante, LocalDateTime fechaInicio, int maximoEntradas, int entradasVendidas, Float precio) {
    ...
    public RestPartidoDto( String nombreVisitante, LocalDateTime fechaInicio, int maximoEntradas, int entradasVendidas, Float precio) {
        this.nombreVisitante=nombreVisitante;
        this.fechaInicio=fechaInicio;
        this.maximoEntradas=maximoEntradas;
        this.entradasVendidas=entradasVendidas;
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof RestPartidoDto that)) return false;
